	...
	private static class Renderer implements GLEventListener{
		...
		public void init( GLAutoDrawable drawable ){
			...
			try{
				...
				forma = org.sam.jogl.ObjLoader.load( path, org.sam.jogl.ObjLoader.RESIZE
						| org.sam.jogl.ObjLoader.GENERATE_TANGENTS, mtd );
				if( showNTB ){
			...
			Textura bump = new Textura( gl, Textura.Format.RGB,
					Imagen.cargarToBufferedImage( "resources/texturas/bump2.png" ), true );
			...
			gl.glLightfv( GLLightingFunc.GL_LIGHT0, GLLightingFunc.GL_POSITION, new float[] { 0.0f, 0.0f, 1.0f, 1.0f }, 0 );
