...
public interface Generator {
	 ...
	 * 
	 */
	final static class Predefined{
		/**
		 * Implementación de un {@code Generator}, que genera primitivas
		 * que sólo contienen sus vértices. 
		 */
		private static class VerticesGenerator implements Generator{
		 ...
		 */
		private static class VerticesNormalsGenerator implements Generator{
		 ...
		 */
		private static class VerticesWireFrameGenerator implements Generator{
			
			VerticesWireFrameGenerator(){}
			...
			public void generate(GL gl,
				...
				gl.glVertexAttrib4f( 0, vert1.x, vert1.y, vert1.z, 1.0f );
				gl.glVertexAttrib4f( 1, vert2.x, vert2.y, vert2.z, 1.0f );
				gl.glVertexAttrib4f( 2, vert3.x, vert3.y, vert3.z, 1.0f );
				gl.glVertexAttrib4f( 3, vert4.x, vert4.y, vert4.z, 1.0f );
		 ...
		 */
		public static final Generator VerticesWireFrame = new VerticesWireFrameGenerator();
	
		/**
		 * Implementación de un {@code Generator}, que genera primitivas
		 * que contienen sus vértices y sus coordenadas de textura.
		 */
		private static class VerticesTexCoordsGenerator implements Generator{
		 ...
		 */
		private static class VerticesNormalsTexCoordsGenerator implements Generator{
		 ...
		 */
		private static class VerticesTangentsGenerator implements Generator{
		 ...
		 */
		public static final class NTBGenerator implements Generator{
			 ...
			 */
			private NTBGenerator(float length) {
				this.length = length;
			}
			 ...
			 * @return
			 */
			public Generator lineLength(float length) {
				return new NTBGenerator(length);
			}
