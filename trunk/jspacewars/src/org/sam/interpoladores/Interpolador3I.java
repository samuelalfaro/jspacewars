...
final class Interpolador3I implements Trayectoria.Integer<int[]>{
	...
	Interpolador3I(int keys[], int[][] values, MetodoDeInterpolacion mdi, Object... params) {
		...
		this.funcionesX = Funcion.toIntegerFunctions(funciones[0]);
		this.funcionesY = Funcion.toIntegerFunctions(funciones[1]);
		this.funcionesZ = Funcion.toIntegerFunctions(funciones[2]);
