...
public abstract class Test00Abs extends JPanel implements MouseListener, MouseMotionListener{
	 ...
	 * @param pX Valor de X en coordenadas <i>world</i>.
	 * @param pY Valor de Y en coordenadas <i>world</i>.
	 * @param width Anchura del punto en pixels.
	 */
	protected final void dibuja( Graphics g, float pX, float pY, int width ){
		dibuja( g, xMundoPantalla( pX ), yMundoPantalla( pY ), width );
	}
	 ...
	 * @param width Anchura del punto en pixels.
	 */
	protected final void dibuja( Graphics g, int pX, int pY, int width ){
