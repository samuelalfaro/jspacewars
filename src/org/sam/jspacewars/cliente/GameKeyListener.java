...
class GameKeyListener implements KeyListener{
	...
	public void keyPressed(KeyEvent keyEvent) {
		...
		switch (keyCode) {
		case K_SUBE:	data.key_state |= KeysState.SUBE;		break;
		case K_BAJA:	data.key_state |= KeysState.BAJA;		break;
		case K_ACELERA:	data.key_state |= KeysState.ACELERA;	break;
		case K_FRENA:	data.key_state |= KeysState.FRENA;		break;
		case K_DISPARO:	data.key_state |= KeysState.DISPARO;	break;
		case K_BOMBA:	data.key_state |= KeysState.BOMBA;		break;
		case K_UPGRADE:	data.key_state |= KeysState.UPGRADE;	break;
		default:
		}
	}
