...
public class CanionData {
	...
	/**
	 * Vector que contiene los tiempos de recarga, en nanosegundos, para los distintos
	 * grados del cañon.
	 */
	final int[] vTRecarga;
	
	/**
	 * Vector que contiene los desfases del disparo, en nanosegundos, para los distintos
	 * grados del cañon.
	...
	/**
	 * Vector que contiene las velocidades del disparo, en unidades por nanosegundos,
