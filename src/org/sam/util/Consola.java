...
/**
 * Clase que proporciona métodos estáticos para poder crear instancias de la clase encapsulada <i>OutputDocumentStream</i> que es
...
public class Consola {
	 ...
	 * @param tamDoc Tamaño maximo del documento, cuando el documento llega al tamaño maximo, se van eliminando
	 * los caracteres más antiguos. Si el tamaño es menor de 0, y el tamaño maximo es indifenido, y no se elimina nada. 
