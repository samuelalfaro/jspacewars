...
public class PruebaFusion extends JComponent{
	...
	public PruebaFusion(){
		...
		int intImg1[] = Imagen.toGrayPixels(Imagen.cargarImagen("resources/img/leds/bt03.png"),100,100); 
...
//			imgs[modo][6]= Imagen.fusionar(intImg1, intImg2, ancho, alto, modo, Imagen.ALFA_SRC);
			imgs[modo][0]= Imagen.fusionar(img2, img1, modo, Imagen.ALFA_OFF);
			imgs[modo][1]= Imagen.fusionar(img2, img1, modo, 0);
			imgs[modo][2]= Imagen.fusionar(img2, img1, modo, 64);
			imgs[modo][3]= Imagen.fusionar(img2, img1, modo, 128);
			imgs[modo][4]= Imagen.fusionar(img2, img1, modo, 192);
			imgs[modo][5]= Imagen.fusionar(img2, img1, modo, 255);
			imgs[modo][6]= Imagen.fusionar(img2, img1, modo, Imagen.ALFA_SRC); 
