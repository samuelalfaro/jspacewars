...
class ParticulasLibres2D extends Particulas{
...
//			pos.put( x0 ); pos.put( y1 );
	...
	protected ParticulasLibres2D( int nParticulas ){
		super( nParticulas );
	...
	protected ParticulasLibres2D( ParticulasLibres2D me ){
		super( me );
	...
	public Particulas clone(){
		return new ParticulasLibres2D( this );
	}
