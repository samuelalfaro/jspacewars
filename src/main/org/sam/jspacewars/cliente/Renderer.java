...
class Renderer implements GLEventListener {
	...
	public void display( GLAutoDrawable drawable ){
		...
		/*
		 * gl.glDisable(GL.GL_TEXTURE_2D); gl.glBegin(GL.GL_LINE_STRIP); gl.glColor4f(1.0f, 1.0f, 1.0f, 1.0f); float
		 * ratio = (30*4.0f/32) / (3.0f - 4*4.0f/32); float h = 3.26f; float w = ratio * h; gl.glVertex2f(-w,-h);
		 * gl.glVertex2f( w,-h); gl.glVertex2f( w, h); gl.glVertex2f(-w, h); gl.glVertex2f(-w,-h); gl.glEnd();
