...
/**
 * 
 * This is a translation of the OggVorbis streamer OpenAL tutorial at
 * http://www.devmaster.net/articles/openal-tutorials/lesson8.php
 * 
 * It uses the Java Ogg library from http://www.j-ogg.de to do the Ogg file
 * decoding...
 * 
...
public class OggStreamer {
	...
	private OggInputStream data_input_stream;
	...
	public boolean open() {
		...
		if( data_input_stream.getFormat() == OggInputStream.FORMAT_MONO16)
			format = ALConstants.AL_FORMAT_MONO16;
		else
			format = ALConstants.AL_FORMAT_STEREO16;
		
		rate = data_input_stream.rate();
