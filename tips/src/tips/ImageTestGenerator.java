...
public class ImageTestGenerator{
	...
	private static class ImageTest extends BufferedImage{
		...
		private final static float[] hueFractions = new float[] {
	...
	private static void export( final int w, final int h, final String formato, final String rutaFichero )
			throws IOException{
